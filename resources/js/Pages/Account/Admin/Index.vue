<template>
    <app-layout title="Admins">
		<template #header>
			...
			<li class="flex items-center text-blue-500">
				<Link :href="'#'" class="text-gray-700" >Admins</Link>
			</li>
        </template>
		
		<template #header_button>
			<Link :href="route('admins.create')"><jet-button class="bg-blue-500 hover:bg-indigo-400 text-white font-bold py-2 px-4 rounded">Tambah</jet-button></Link>
        </template>
